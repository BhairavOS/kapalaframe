...
#define __visitForwardLike$(T, ...) static_cast<typename ::Kapalaframe::Meta::_VisitForwardLike<::Kapalaframe::Meta::LvalueRef<T>>::template type<decltype(__VA_ARGS__)>>(__VA_ARGS__)
